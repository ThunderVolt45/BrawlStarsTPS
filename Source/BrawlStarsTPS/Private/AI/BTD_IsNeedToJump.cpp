...
UBTD_IsNeedToJump::UBTD_IsNeedToJump()
{
	NodeName = TEXT("Is Need To Jump");
}

bool UBTD_IsNeedToJump::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
